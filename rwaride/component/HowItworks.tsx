      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {steps.map((item, i) => (
          ...
          >
            ...
            <div
              className={`w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center text-white font-bold text-lg bg-primary-color-500`}
            >
              {item.step}
            </div>
            <h3 className="text-xl font-semibold text-primary-color-800 mb-3">
              {item.title}
            </h3>
