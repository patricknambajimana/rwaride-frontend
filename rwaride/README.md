...
- Promotes **shared mobility** and reduces CO₂ emissions  
- Supports **community collaboration** and safety  
...
| Category | Technology |
|-----------|-------------|
| **Frontend (Web)** | [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/), [Framer Motion](https://www.framer.com/motion/) |
| **Mobile App** | [React Native](https://reactnative.dev/) |
| **Backend** | [Node.js](https://nodejs.org/), [Express.js](https://expressjs.com/) |
| **Database** | [MongoDB](https://www.mongodb.com/) / [Firebase](https://firebase.google.com/) |
